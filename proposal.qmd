...
This data came from Equity in Athletics Data Analysis (EADA). it was collected through required reports from post-secondary institutions that receive Title IX funding.
...
equity <- read_csv("data/Schools 2020-21.csv")
glimpse(equity)
```
